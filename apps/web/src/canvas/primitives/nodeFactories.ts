import type { EllipseNode, FrameNode, NodeId, PathNode, PathPoint, RectNode, Semantics, StrokeStyle, TextNode } from "@open-canvas/schema";
...
export function makePath(
  ...
  return {
    ...
    sizingVertical: "fixed",
    positioning: "flow",
    subpaths: [{ points: props.points, closed: props.closed ?? false }],
    fillRule: "nonzero",
    fill: props.fill ?? null,
    stroke: props.stroke ?? null,
